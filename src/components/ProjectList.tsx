  ...
  return (
    <>
      <div className="mx-auto max-w-3xl h-auto pt-40">
        ...
        <hr className="bg-header rounded-sm w-full h-0.5 border-0 place-self-center"></hr>
        <div className="md:flex py-12">
          ...
          <div className="pl-8 max-w-[40rem]">
            <div className="font-almarai text-project text-4xl font-extrabold pb-4">{projectNames[1]}</div>
            <div className="font-inter">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec mollis pulvinar viverra. Suspendisse nibh erat, dictum eu diam semper, dapibus consequat tortor. Nulla facilisis lorem ut ligula scelerisque, vitae gravida velit cursus. Integer tincidunt nisi semper purus ultricies, in semper mauris egestas. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Donec gravida diam libero, et sodales ligula suscipit sed. Etiam iaculis ligula et quam blandit dictum.</div>
          </div>
        </div>
        <div className="pb-12 md:pl-40 max-w-80 md:mx-0 mx-auto md:text-left text-center">
        ...
        <div className="md:flex py-12">
          ...
          <div className="pl-8 max-w-[40rem]">
            <div className="font-almarai text-project text-4xl font-extrabold pb-4">{projectNames[2]}</div>
            <div className="font-inter">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec mollis pulvinar viverra. Suspendisse nibh erat, dictum eu diam semper, dapibus consequat tortor. Nulla facilisis lorem ut ligula scelerisque, vitae gravida velit cursus. Integer tincidunt nisi semper purus ultricies, in semper mauris egestas. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Donec gravida diam libero, et sodales ligula suscipit sed. Etiam iaculis ligula et quam blandit dictum.</div>
          </div>
        </div>
        <div className="pb-12 md:pl-40 max-w-80 md:mx-0 mx-auto md:text-left text-center">
