...
function NavigationBar() {
  return (
  <>
    <Disclosure as="nav" className="bg-navbg fixed top-0 h-auto w-full">
        ...
        <div className="relative flex h-18 items-center justify-between">
          ...
          <a href="https://github.com/roscoe-patnode" target="blank_">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 98"
              className="h-8 w-8 fill-current text-main hover:text-hover-main hover:bg-hover-navbg rounded-full">
