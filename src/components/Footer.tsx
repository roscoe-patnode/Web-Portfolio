    ...
    <footer className="bg-gradient-to-br to-header from-hover-btnbg py-45 place-content-center">
      <div className="max-w-5xl lg:place-self-center lg:flex pb-20 pl-5 lg:pl-0">
        ...
        <div className="w-sm mx-auto">
          ...
          <div className="font-inter w-full text-lg text-pagebg-sec pb-1"><a className="hover:underline"href="" target="_blank">Event Connect</a></div>
          <div className="font-inter w-full text-lg text-pagebg-sec pb-1"><a className="hover:underline"href="" target="_blank">Portfolio Website</a></div>
        </div>
        <div className="w-sm mx-auto">
