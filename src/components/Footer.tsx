  ...
  return (
    <footer className="bg-gradient-to-br to-header from-hover-btnbg py-45">
      <div className="max-w-5xl lg:place-self-center lg:flex pb-20 pl-5 lg:pl-0">
        ...
        <div className="w-sm mx-auto">
          <div className="font-lexend-exa w-full text-xl font-extrabold text-subheader pb-2">GitHub Projects</div>
        ...
        <div className="w-sm mx-auto">
          <div className="font-lexend-exa w-full text-xl font-extrabold text-subheader pb-2">Other</div>
